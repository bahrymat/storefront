...
function parseForms() {
	...
	var formObject = {elements: []};
	var fields;
	$('.storeform-container').each(function (i) {
		formObject.elements[i] = {};
		$(this).find('.storeform').each(function () {
			formObject.elements[i][this.id] = this.value;
		});
	});
