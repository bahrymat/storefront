...
$("ul.newElement > li#ProductList").click(
				function(){var productlistform = '<div class="col-sm-6 productblockBox"><div class="block"><div class="titles">Product List<button type="button" class="close deleteProductblock" aria-hidden="true">&times;</button></div><form class="form-horizontal element-container" role="form"><div class="form-group"><div class="col-sm-6"><select class="form-control storeform" id="prodList1"><option>None</option><option>product1</option><option>product2</option><option>product3</option><option>product4</option><option>product5</option></select></div><div class="col-sm-6"><select class="form-control storeform" id="prodList2"><option>None</option><option>product1</option><option>product2</option><option>product3</option><option>product4</option><option>product5</option></select></div><div class="col-sm-6"><select class="form-control storeform" id="prodList3"><option>None</option><option>product1</option><option>product2</option><option>product3</option><option>product4</option><option>product5</option></select></div><div class="col-sm-6"><select class="form-control storeform" id="prodList4"><option>None</option><option>product1</option><option>product2</option><option>product3</option><option>product4</option><option>product5</option></select></div><div class="col-sm-6"><select class="form-control storeform" id="prodList5"><option>None</option><option>product1</option><option>product2</option><option>product3</option><option>product4</option><option>product5</option></select></div><div class="col-sm-6"><select class="form-control storeform" id="prodList6"><option>None</option><option>product1</option><option>product2</option><option>product3</option><option>product4</option><option>product5</option></select></div><div class="col-sm-6"><select class="form-control storeform" id="prodList7"><option>None</option><option>product1</option><option>product2</option><option>product3</option><option>product4</option><option>product5</option></select></div><div class="col-sm-6"><select class="form-control storeform" id="prodList8"><option>None</option><option>product1</option><option>product2</option><option>product3</option><option>product4</option><option>product5</option></select></div><label for="pos" class="col-sm-3 control-label">Position</label><div class="col-sm-9"><input type="number" class="form-control storeform" id="pos" placeholder="n + 1"></div></form></div></div>';
